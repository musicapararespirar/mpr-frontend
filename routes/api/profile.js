...
router.post(
    ...
    async (req, res) => {
        ...
        if (skills) {
            profileFields.skills = skills.split(',').map(skill => skill.trim()) // Split by commas, trim space and create array
        }
...
router.get('/user/:user_id', async (req, res) => {
    try {
        const profile = await Profile.findOne({ user: req.params.user_id }).populate('user', ['name', 'avatar']); // User ID comes from URL params
...
router.delete('/', auth, async (req, res) => {
    try {
        ...
        // Remove user profile
        // Private so we have access to token
...
router.put(
    ...
    async (req, res) => {
        ...
        try {
            ...
            profile.experience.unshift(newExp); // Same as shift but puts on beginning than end
...
router.delete('/experience/:exp_id', auth, async (req, res) => {
    try {
        ...
        profile.experience.splice(removeIndex, 1) // Splice to take something out
...
router.put(
    ...
    async (req, res) => {
        ...
        try {
            ...
            profile.education.unshift(newEdu); // Same as shift but puts on beginning than end
...
router.delete('/education/:edu_id', auth, async (req, res) => {
    try {
        ...
        profile.education.splice(removeIndex, 1) // Splice to take something out
