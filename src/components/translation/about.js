export default {
    ...
    // Bios
    'camilabio': {en: '', es: 'Nacida en Cochabamba, Camila es Clarinete Solista de la Orquesta Sinfónica Municipal de São Paulo. Ha tocando con la Filarmónica de Nueva York, la Sinfónica de Miami, la Orquesta de las Americas, entre otras. Recibió su maestría y licenciatura de Manhattan School of Music en Nueva York. Se presentó en los más destacados palcos alrededor del mundo como ser Carnegie Hall, Berlin Konzerhaus, así como en espacios inusitados como la Basílica de San Pedro en el Vaticano, LPR y la Isla del Sol en el Lago Titikaka. También goza de una intensa actividad de música de cámara, fue integrante del premiado quinteto de maderas The City of Tomorrow y es directora artística de la Sociedad Boliviana de Música de Cámara. Camila vive en São Paulo con su compañero y su perrita Osita.', pt: ''},
    'brunobio': {en: '', es: 'Brasileño, aclamado como “impresionantemente seguro” por el New York Times y “simplemente estupendo” por el periódico inglés Arts Desk, Bruno es trompetista principal de la Orquestra Filarmonica Bachiana, invitado de la Osesp - Orquestra Sinfônica do Estado de São Paulo, miembro de la Portland Baroque Orchestra y co-fundador de La Sociedad Boliviana de Música de Cámara. Recibió diplomas de performance de Mannes College NY, Indiana University, maestria de University of Southern Mississippi y licenciatura de la Universidad de São Paulo. Es profesor en el Festival Internacional de Bauru y el Festival Música nas Montanhas y actualmente reside en São Paulo.', pt: ''},
    'vaniabio': {en: '', es: 'Cochabambina, realizó sus estudios en el Instituto Eduardo Laredo, la academia Interlochen Arts Academy (E.E.U.U.) y en la Universidad del Estado de Michigan. También es graduada del  Programa de  Líderes Globales de la Orquesta de las Américas. A través de su carrera, Vania Andrea ha sido integrante de diferentes orquestas y participado en giras orquestales a través de Bolivia, Latinoamérica, Estados Unidos, Canadá y Europa.  Actualmente reside en la ciudad de La Paz y es parte de la Fundación Bolivia Clásica y de la Orquesta Sinfónica Nacional.', pt: ''},
    'anahibio': {en: '', es: 'Nacida en Cochabamba, empezó a tocar el cello a los 10 años en el Instituto Eduardo Laredo. Posteriormente continuó sus estudios en la ciudad de La Paz y en el Reino Unido. Realizó un Music BA en Newcastle University y un Master of Music - Creative Musician en Leed College of Music. Tuvo la oportunidad de participar en proyectos musicales tanto en Bolivia como el Reino Unido y tiene un gran interés en la musicología cultural.', pt: ''},
    'claudiabio': {en: '', es: 'Boliviana, 22 años. Además de ser parte del equipo de la Sociedad Boliviana de Música de Cámara, desde 2018 es Academista de la Orquesta Sinfónica del Estado de São Paulo (Osesp) guiada por Pedro Gadelha y es miembro del grupo de música de cámara PianoSofia junto con Cristian Budu. Ganadora de numerosos concursos y solista en una ocasión con la Orquesta Filarmónica de Jena (Alemania). Actualmente reside en Brasil y estudia el Bachelor en Contrabajo en la Universidad Estadual Paulista (UNESP).', pt: ''},
    'fernandobio': {en: '', es: 'Nacido en Sucre, antigua ciudad de La Plata, donde inició estudios musicales y de Piano con Jorge García Marin. Estudió en San Ignacio de Moxos, y aprendió a amar a Bach con Elizabeth Schwimmer en Cochabamba. Actualmente estudia con Dr. Michael Baron y es beneficiario de la beca “Charles Lussenhop and Kayetta Slocum Scholarship” y “Nisita Fund for Music Excellence” en Bower School of Music, Florida Gulf Coast University. Es miembro de La Sociedad Boliviana de Música de Cámara, fundador del Festival PianoeMusica y co-fundador de la asociación de pianistas bolivianos Con Fuoco.', pt: ''},
    'gabrielbio': {en: '', es: 'Mejor conocido como Gabo, nació en La Paz. Empezó sus estudios musicales en Tarija con Franz Condori. Más tarde continuó en la Escuela Municipal de las Artes de El Alto con Fredy Céspedes y en el Programa de Formación Musical "Bolivia Clásica" con Armando Vera y Alexander Lapich. Actualmente es parte del Cuarteto Clova y estudia en la Real Academia de Música de Londres, bajo la tutela del violinista Jack Liebeck.', pt: ''},
    'karinbio': {en: '', es: 'Nacida en Santa Cruz de la Sierra, violinista e investigadora especializada en Interpretación Históricamente Informada, Karin ha estudiado en EEUU en Montclair State University, Case Western Reserve University y en Londres en la Royal Academy of Music. Formó parte de distinguidos ensambles de música antigua en Europa y Norteamérica tales como American Bach Soloists, Apollo’s Fire, Oxford Bach Soloists, Les Boreades,L’Harmonie des Saisons, entre otros. Actualmente reside en Montreal Canadá donde cursa el PhD en Musicología en la Universidad McGill.', pt: ''},
    'karlabio': {en: '', es: 'Nacida en Cochabamba, inició sus estudios de Música en el Instituto Eduardo Laredo y cursó numerosos Talleres, Festivales y Masterclasses en Bolivia y en el extranjero. Formó parte de muchas agrupaciones como la Orquesta Filarmónica de Cochabamba, DJazz Big band y Cochabamba Wind Symphony y fué solista en varias ocasiones con la Orquesta Sinfónica Juvenil de las Jornadas de Música contemporánea. Realizó el estreno de obras como: “Fantasía para clarinete y piano” de David Valdivieso y recientemente “Tres invenciones sobre aires bolivianos” de Nicolás Suarez. Es especialista en Clarinete Soprano y Clarinete Píccolo y también es conocida por realizar mantenimiento y restauración de Clarinetes. Actualmente reside en Cochabamba y se desempeña como docente de Clarinete en el Instituto Eduardo Laredo.', pt: ''},
    'paolabio': {en: '', es: 'Cochabambina de 22 años, Paola es parte del equipo de La Sociedad Boliviana de Música de Cámara, y miembro de la Orquestra Jovem do Estado de São Paulo. Además, forma parte del grupo de percusión PIAP y estudia Bachelor en Percusión en la Universidad Estadual Paulista UNESP. Participó en muchos festivales internacionales, entre ellos: Festival Campos de Jordão (Brasil), Festival Música nas Montanhas (Brasil) y como jefe de sección Britten-Pears Orchestra (Reino Unido). Paola ganó el primer Premio Ernani de Almeida Machado 2020, obteniendo el primer premio una beca de R$100 mil reales (U$20 mil dólares) para perfeccionar sus estudios en el exterior.', pt: ''},

    // Bio quotes
    'camilaquote': {en: '', es: '', pt: ''},
    'brunoquote': {en: '', es: '', pt: ''},
    'vaniaquote': {en: '', es: 'Dando también se recibe. A veces estamos tan enfrascados en nuestras propias necesidades, que nos olvidamos que el dar, el dar nuestro talento y nuestro amor es aquello que también nos llena. Si se puede sacar una sonrisa, evocar remembranzas o por lo menos distraer a ese alguien que lo necesita en momentos oscuros, estamos cumpliendo nuestra misión como músicos y seres humanos', pt: ''},
    'anahiquote': {en: '', es: 'Este proyecto me permitirá contribuir al menos un poco en el bienestar de las personas. Música para respirar 24/7  es una oportunidad para que los músicos podamos volver a conectarnos con la gente y compartamos nuestro arte con ellos', pt: ''},
    'claudiaquote': {en: '', es: 'Quiero participar porque quiero dar amor, aire, paz, y viajar a través de la música, en estos tiempos inciertos, pero llenos de esperanza', pt: ''},
    'fernandoquote': {en: '', es: 'Nunca antes como ahora, dependemos tanto de tan poco; unos minutos pueden ser suficientes para salvarnos la vida; queremos ofrecer unos instantes de música a todos los que en ella puedan encontrar luz y esperanza.', pt: ''},
    'gabrielquote': {en: '', es: 'Durante la pandemia, si bien los efectos fisiológicos del virus son fuertes, también lo son los psicológicos, no sólo para los doctores, pacientes y allegados, también para el público en general que vive en constante miedo. Tener la oportunidad de llegar a las personas para brindar paz, aunque por un corto período de tiempo, añade un propósito noble a lo que hacemos', pt: ''},
    'karinquote': {en: '', es: 'Estoy muy emocionada de formar parte del proyecto Música que Sana y Música para Respirar 24/7, porque creo en el poder sanador de la música y quiero ofrecer mi arte a la población Boliviana tan afectada por Covid-19', pt: ''},
    'karlaquote': {en: '', es: 'Estoy muy feliz de ser parte de ‘La Sociedad’ y participar en la actividad Música para respirar 24/7, pienso que regalar música a la gente afectada en esta pandemia puede hacer viajar a la mente, elevar el espíritu y sanar el cuerpo', pt: ''},
    'paolaquote': {en: '', es: 'Quiero participar porque quiero viajar con los oyentes a un espacio de Paz, Amor y Unión', pt: ''},
}
